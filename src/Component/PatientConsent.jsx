  ...
  return (
    <StyledForm form={form} onFinish={onFinish} initialValues={formData}>
      ...
      <Paragraph style={{ textAlign: "left" }}>
        ...
        right to reserve its Notice of Privacy Practices at any time. A revised
        Notice of Privacy Practices may be obtained by forwarding a WRITTEN
        REQUEST to the privacy officer, MaChere Chiles.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        ...
        pertaining to test results. I understand that I will be asked a security
        question to obtain my test results.
      </Paragraph>
      ...
      <Paragraph>
        ...
        lab testing to another physician or facility, any item that assists the
        practice in carrying out the TPO. With this consent I also give
      ...
      <Paragraph>
        I have the right to request that GEM LUXE AESTHETICS office restrict how
        it uses or discloses my PHI to carry out TPO. However, the practice is
        not required to agree to my requested restrictions, but if it does it is
        bound by this agreement.
      </Paragraph>
      <Paragraph>
        By signing this form, I am consenting to GEM LUXE AESTHETICS to use and
        disclosure of my PHI to carry out TPO.
      </Paragraph>
      <Paragraph>
        I may revoke my consent in writing to the extent that the practice has
        already made disclosures in reliance upon my prior consent. If I do not
        sign this consent, or later revoke it,{" "}
