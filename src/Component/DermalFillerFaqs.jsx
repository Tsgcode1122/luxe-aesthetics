...
const DermalFillerFaqs = () => {
  ...
  const isFillersPage = location.pathname === "/filler";
  ...
  return (
    <>
      <FaqsContainer>
        <Content isFillersPage={isFillersPage}>
          <Heading> Dermal Fillers Faqs</Heading>
...
const Content = styled.div`
  padding: 2rem;
  height: ${(props) => (props.isFillersPage ? "auto" : "70vh")};
  &::-webkit-scrollbar {
