 ...
 <p style=" font-size: 18px; ">I permit the Practice to call the following <strong>telephone number</strong> <span style="border-bottom: 1px solid #000; display: inline-block; width: 40%; padding: 7px;">${
  ...
  return (
    <StyledForm form={form} onFinish={onFinish} initialValues={formData}>
      ...
      <Title>
        CONSENT FOR EMAIL/ TEXT/ TELEPHONE CALL APPOINTMENT REMINDERS/ REMINDER
        COMMUNICATIONS
      </Title>
      <Paragraph style={{ textAlign: "center" }}>
        This Consent Form is an acknowledgment by you and an express consent to
        receive emails, text messages, and/or automatic telephone communications
        from <strong>Gem Luxe Aesthetics </strong>(the "Practice"). By signing
        this form you understand that by providing your consent you recognize
        the email, text messaging, and telephone communications are not a secure
        form of communication. Please note that the email, text messaging, and
        telephone communications are not a secure form of communication. There
        is some risk that any protected health information that may be contained
        in such email or text message communications may be disclosed to, or
        intercepted by, unauthorized third parties.{" "}
        <strong>
          You are expressly urged to never send protected health information via
          text, email, or otherwise. The Practice will not send protected health
          information via text message or email.{" "}
        </strong>{" "}
        Patients in the practice may be contacted via email and/or text
        messaging to remind them of an appointment, to obtain feedback on their
        experience with the healthcare team, special offers, newsletters, and to
        provide general health reminders/information.
      </Paragraph>
      ...
      >
        The cell phone number I am authorizing to receive such text messages is:
      ...
      <Paragraph>
        In order to provide appointment reminders. I expressly acknowledge that
        the appointment reminders may be made by a computer or automated system
        and may not be a live person making such a call.
      </Paragraph>
      <Form.Item>
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <Form.Item name="patientInitials" noStyle>
      ...
      <Paragraph>
        ...
        offers, newsletters, and general health information, unless I request a
        change in writing. I understand that I am not required to consent to
        these services in order to continue to receive treatment at the
        Practice. Any consent provided by executing this form may be revoked at
        any time by me, in writing, as provided below.
      </Paragraph>
      <Form.Item>
        <div>
          <span>Patient Name: </span>
