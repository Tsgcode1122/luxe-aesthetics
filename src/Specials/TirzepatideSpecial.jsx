...
import offerImage from "../Image2025/tirzb.png";
import variesImage from "../Image2025/tirz.jpg";
...
const TirzepatideSpecial = () => {
  ...
  return (
    <OfferSection>
      ...
      <Heading>
        <h2>TirzepatideSpecial </h2>
        <span>GIP/GLP-1 Combo</span>
      </Heading>
      <div>
        <SectionText>
          Experience the future of weight management with Tirzepatide, a
          dual-action solution that targets both GIP and GLP-1 receptors. An
          ideal option for those seeking fast sustainable result
        </SectionText>
        <PriceContainer>
      ...
      <SectionText>
        ...
        <div>
          <SectionTitle>Why Tirzepatide</SectionTitle>
          <FeaturesList>
            <li>
              <strong>Comprehensive Approach:</strong> Supports weight loss and
              blood sugar regulation.
            </li>
            <li>
              <strong>Targeted Fat Reduction:</strong> Effectively targets
              visceral fat for a healthier body composition.
            </li>
            <li>
              <strong>Blood Sugar Management:</strong> Helps manage blood sugar
              while curbing appetite.
            </li>
            <li>
              <strong>Clinically Backed:</strong> Supported by scientific
...
export default TirzepatideSpecial;
